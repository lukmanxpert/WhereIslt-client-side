const Footer = () => {
    return (
        <footer className="px-4 bg-white text-black dark:bg-slate-950 divide-y dark:bg-dark dark:text-white">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-primary">
                        ...
                        <span className="self-center text-2xl font-semibold">WhereIsIt</span>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-300"><small>© 2025 <span className="text-primary">WhereIsIt</span>. All rights reserved.</small></div>
        </footer>
    );
};
